...
public class HotelAgentEndpoints {
    public HotelAgentEndpoints(final HotelService hotelService, final RoomService roomService, final HotelRepository hotelRepository, RoomRepository roomRepository) {
